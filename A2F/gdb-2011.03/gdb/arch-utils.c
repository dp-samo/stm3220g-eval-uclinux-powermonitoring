...
/* By default the "return address register" is the unwound PC.  */

int
default_frame_saved_return_address_p (struct gdbarch *gdbarch,
				      struct frame_info *this_frame)
{
  return frame_saved_register_p (this_frame, gdbarch_pc_regnum (gdbarch));
}
