...
extern int gdb_filename_cmp (const char *a, const char *b);
...
char *make_arg_string (const char **argv);
...
#define ISATTY(FP) (gdb_isatty (fileno (FP)))

extern int gdb_isatty (int fd);
