...
extern int gdbarch_register_rtos_regno_p (struct gdbarch *gdbarch);

typedef int (gdbarch_register_rtos_regno_ftype) (struct gdbarch *gdbarch, int reg_nr);
extern int gdbarch_register_rtos_regno (struct gdbarch *gdbarch, int reg_nr);
extern void set_gdbarch_register_rtos_regno (struct gdbarch *gdbarch, gdbarch_register_rtos_regno_ftype *register_rtos_regno);
...
typedef enum return_value_convention (gdbarch_return_value_ftype) (struct gdbarch *gdbarch, struct type *functype, struct value *function, struct regcache *regcache, gdb_byte *readbuf, const gdb_byte *writebuf);
extern enum return_value_convention gdbarch_return_value (struct gdbarch *gdbarch, struct type *functype, struct value *function, struct regcache *regcache, gdb_byte *readbuf, const gdb_byte *writebuf);
...
/* Return 1 if this frame saved its return address somewhere other
   than in the incoming register.  Used to terminate unwinding. */

typedef int (gdbarch_frame_saved_return_address_p_ftype) (struct gdbarch *gdbarch, struct frame_info *this_frame);
extern int gdbarch_frame_saved_return_address_p (struct gdbarch *gdbarch, struct frame_info *this_frame);
extern void set_gdbarch_frame_saved_return_address_p (struct gdbarch *gdbarch, gdbarch_frame_saved_return_address_p_ftype *frame_saved_return_address_p);
