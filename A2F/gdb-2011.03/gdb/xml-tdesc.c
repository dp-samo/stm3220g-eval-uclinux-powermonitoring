...
/* CodeSourcery local: warn about obsolete descriptions.  */

static void
tdesc_start_feature_set (struct gdb_xml_parser *parser,
			 const struct gdb_xml_element *element,
			 void *user_data, VEC(gdb_xml_value_s) *attributes)
{
  warning (_("XML target description contains a <feature-set> element"));
  warning (_("(remote debug stub may be outdated)"));
}
...
static const struct gdb_xml_attribute reg_attributes[] = {
  ...
  { "offset", GDB_XML_AF_OPTIONAL, gdb_xml_parse_attr_ulongest, NULL },
  { "read-sensitive", GDB_XML_AF_OPTIONAL,
    gdb_xml_parse_attr_enum, gdb_xml_enums_boolean },
  { NULL, GDB_XML_AF_NONE, NULL, NULL }
};
...
static const struct gdb_xml_element target_children[] = {
  ...
  { "feature-set", NULL, NULL, GDB_XML_EF_OPTIONAL,
    tdesc_start_feature_set, NULL },
  { NULL, NULL, NULL, GDB_XML_EF_NONE, NULL, NULL }
};
