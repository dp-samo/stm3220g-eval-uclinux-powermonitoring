...
struct gdbarch
{
  ...
  gdbarch_register_rtos_regno_ftype *register_rtos_regno;
  ...
  gdbarch_frame_saved_return_address_p_ftype *frame_saved_return_address_p;
...
struct gdbarch startup_gdbarch =
{
  ...
  0,  /* frame_num_args */
  0,  /* frame_align */
  default_frame_saved_return_address_p,  /* frame_saved_return_address_p */
               ...
               struct gdbarch_tdep *tdep)
{
  ...
  gdbarch->frame_saved_return_address_p = default_frame_saved_return_address_p;
...
verify_gdbarch (struct gdbarch *gdbarch)
{
  ...
  /* Skip verify of register_rtos_regno, has predicate */
  ...
  /* Skip verify of frame_saved_return_address_p, invalid_p == 0 */
...
gdbarch_dump (struct gdbarch *gdbarch, struct ui_file *file)
{
  ...
  fprintf_unfiltered (file,
                      "gdbarch_dump: frame_saved_return_address_p = <%s>\n",
                      host_address_to_string (gdbarch->frame_saved_return_address_p));
  fprintf_unfiltered (file,
  ...
  fprintf_unfiltered (file,
                      "gdbarch_dump: gdbarch_register_rtos_regno_p() = %d\n",
                      gdbarch_register_rtos_regno_p (gdbarch));
  fprintf_unfiltered (file,
                      "gdbarch_dump: register_rtos_regno = <%s>\n",
                      host_address_to_string (gdbarch->register_rtos_regno));
  fprintf_unfiltered (file,
...
int
gdbarch_register_rtos_regno_p (struct gdbarch *gdbarch)
{
  gdb_assert (gdbarch != NULL);
  return gdbarch->register_rtos_regno != NULL;
}

int
gdbarch_register_rtos_regno (struct gdbarch *gdbarch, int reg_nr)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->register_rtos_regno != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_register_rtos_regno called\n");
  return gdbarch->register_rtos_regno (gdbarch, reg_nr);
}

void
set_gdbarch_register_rtos_regno (struct gdbarch *gdbarch,
                                 gdbarch_register_rtos_regno_ftype register_rtos_regno)
{
  gdbarch->register_rtos_regno = register_rtos_regno;
}
...
gdbarch_return_value (struct gdbarch *gdbarch, struct type *functype, struct value *function, struct regcache *regcache, gdb_byte *readbuf, const gdb_byte *writebuf)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->return_value != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_return_value called\n");
  return gdbarch->return_value (gdbarch, functype, function, regcache, readbuf, writebuf);
}
...
int
gdbarch_frame_saved_return_address_p (struct gdbarch *gdbarch, struct frame_info *this_frame)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->frame_saved_return_address_p != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_frame_saved_return_address_p called\n");
  return gdbarch->frame_saved_return_address_p (gdbarch, this_frame);
}

void
set_gdbarch_frame_saved_return_address_p (struct gdbarch *gdbarch,
                                          gdbarch_frame_saved_return_address_p_ftype frame_saved_return_address_p)
{
  gdbarch->frame_saved_return_address_p = frame_saved_return_address_p;
}
...
{
  struct gdbarch *old_gdbarch = target_gdbarch;

  gdb_assert (new_gdbarch != NULL);
  gdb_assert (new_gdbarch->initialized_p);
  target_gdbarch = new_gdbarch;
  observer_notify_architecture_changed (new_gdbarch);
  observer_notify_arch_changed (old_gdbarch, new_gdbarch);
  registers_changed ();
}
