...
/* Set VAR to VAL.  VAR will have a lazy value if VAL does (and VAL
   is not an integer or pointer type).  */

void
set_internalvar_lazy (struct internalvar *var, struct value *val)
{
...
set_internalvar (struct internalvar *var, struct value *val)
{
  ...
  /* Since we've already fetched the value, the value copied
     into internal variable won't be lazy.  */
  set_internalvar_lazy (var, val);
}
		     ...
		     struct type *func_type, struct value *function)
{
  ...
  return (gdbarch_return_value (gdbarch, func_type, function,
				NULL, NULL, NULL)
