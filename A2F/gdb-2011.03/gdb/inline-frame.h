...
/* Return true if we have call site information for the inline frame
   FRAME.  If so, fills SAL with it.  */

int inline_call_site (struct frame_info *frame, struct symtab_and_line *sal);
